...
__C {
    ...
    __export bool llaisysQwen2ModelLoadWeight(struct LlaisysQwen2Model* model,const char* weight_name,const void* data,const size_t* shape,size_t ndim,int dtype);
}
